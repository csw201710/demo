#ifndef _H_LOGC_00abc
#define _H_LOGC_00abc
...
#ifdef __cplusplus
#define LOG LOG_NAMESPACE_00ab
namespace LOG{
//extern "C" {
#endif

//user defined
#define LOG_FILE_NAME "log-001.txt"
#define MAX_FILE_LOG_SIZE (1024 * 1024 * 256)
