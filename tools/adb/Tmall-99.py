...
task1()
task2()
#adb shell input swipe 100 100 200 200  300 //从 100 100 经历300毫秒滑动到 200 200  input swipe [duration(ms)] 
os.system('adb shell input swipe 900 1600 900 1200')    # 下拉任务列表
time.sleep(1)
task3()
print('全部任务已完成')
os.system("pause")
